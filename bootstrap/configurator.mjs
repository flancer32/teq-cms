 ...
 * @description Pre-DI host container configurator for TeqCMS CLI composition.
 *
 ...
 * must not declare or resolve DI dependencies.
 * @implements {TeqFw_Cli_Api_Container_Configurator}
 */
export default class Configurator {
    /**
     * Returns host Container configuration extensions.
     *
